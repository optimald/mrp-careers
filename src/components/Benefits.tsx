          ...
          {benefits.map((benefit, index) => (
            <div key={index} className="bg-white rounded-lg p-6 shadow-sm border border-gray-200">
              <div className="flex items-center space-x-3">
                <div className="w-8 h-8 bg-mrp-100 rounded-full flex items-center justify-center">
                  <svg className="w-4 h-4 text-mrp-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
